...
var sendEmail = function (receiverEmail, subject, templateData, template, cb) {
    let rootPath = path.normalize(__dirname + '/..');
    var templateDir = path.join(rootPath, 'app', 'modules', 'templates', 'email', template);
    ...
    fs.lstat(templateDir, function (err, stats) {
        ...
        testTemplate.render(templateData || {}).then(function (result) {
            var mailOptions = {
                from: 'YamUp <info@onpremiseit.com>', // sender address
